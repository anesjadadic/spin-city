...
<body>
    <div class="m-5 text-center">
        <h1 class="text-primary text-weight-bold">Employee Log In</h1>
        <div class="login-signup-form">
            <form action="includes/login-employee.inc.php" method="POST">
            ...
            ?>
            <a class="fixed-bottom m-5" href="customerLogin.php">User Login</a>
        </div>
    </div>
</body>
</html>